    ...
    if($emailcount >0){
        echo "email already exists";
            ...
            if($password=== $cpassword){
                $insertquery = "insert into registrationemail(username,email,mobile,password,cpassword,token,status) value('$username','$email','$mobile','$pass','$cpass','$token','inactive')";
                ...
                if($iquery){
                    ...
                    $body = "Hi , $username. Click here too activate your account http://localhost/PHP/registationemail/activate.php?token=$token";
